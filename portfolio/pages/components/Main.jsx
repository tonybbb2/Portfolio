                    ...
                    <div className='mx-auto max-w-2xl lg:max-w-5xl'>
                        <div className='top-[var(--avatar-top,theme(spacing.3))] w-full'>
                            <div className='relative'>
                                <div className='absolute left-0 top-[100px] origin-left transition-opacity rounded-full bg-white/90 p-0.5 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:ring-white/10'>
