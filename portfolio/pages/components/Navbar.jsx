    ...
    return (
        <div className={'relative flex justify-center w-full h-10 top-5 z-[100] gap-[10px]' }>
            ...
            <div onClick={handleNav} className='flex justify-end md:hidden'>
                <button className="group flex items-center rounded-full bg-white/90 px-4 py-2 text-sm font-medium text-zinc-800 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10 dark:hover:ring-white/20" type="button" aria-expanded="false">Menu<svg viewBox="0 0 8 6" aria-hidden="true" className="ml-3 h-auto w-2 stroke-zinc-500 group-hover:stroke-zinc-700 dark:group-hover:stroke-zinc-400"><path d="M1.75 1.75 4 4.25l2.25-2.5" fill="none" strokeWidth="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg></button>
            </div>
            <div className='hidden justify-end md:justify-center rounded-full md:flex flex-1 bg-white dark:bg-[#252529] shadow-lg ring-1 ring-zinc-900/5'>
                <nav>
                    <ul className='flex rounded-full w-full h-full text-black dark:text-white font-semibold font-display text-md'>
                        ...
                        <Link href='/#Blog'>
                            <li className='relative block px-4 py-2 transition hover:text-red-600'>Blog</li>
                        </Link>
                        <Link href='/#skills'>
                            <li className='relative block px-4 py-2 transition hover:text-red-600'>Skills</li>
                        </Link>
                        <Link href='/#projects'>
                            <li className='relative block px-4 py-2 transition hover:text-red-600'>Projects</li>
                        </Link>
                        <Link href='/#contact'>
                            <li className='relative block px-4 py-2 transition hover:text-red-600'>Contact</li>
                        </Link>
                    </ul>
                </nav>
            </div>
            <div className='flex justify-start md:flex-1 md:pl-32'>
                ...
                <button type="button" aaria-label="Toggle dark mode" className="group rounded-full px-3 py-2 shadow-lg ring-1 ring-zinc-900/5 backdrop-blur transition dark:bg-zinc-800/90 dark:ring-white/10 dark:hover:ring-white/20  ml-2">
                ...
                <div id="dropdown-lang" className={lang ? "absolute w-[45px] top-12 z-10 bg-white rounded-lg ring-1 ring-zinc-900/5 backdrop-blur transition dark:bg-zinc-800/90 dark:ring-white/10 dark:hover:ring-white/20" : "hidden"}>
                    ...
                    <li>
                        <a href="#" className="block py-2 text-center hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">FR</a>
                    </li>
                    <li>
                        <a href="#" className="block mx-auto py-2 text-center hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">EN</a>
                    </li>
                    </ul>
                </div>
            </div>
            <div className={nav ? 'fixed inset-x-4 top-8 z-50 origin-top rounded-3xl bg-white p-8 ring-1 ring-zinc-900/5 dark:bg-zinc-900 dark:ring-zinc-800 md:hidden' : 'hidden'}>
                <div className='flex flex-row-reverse items-center justify-between'>
                    <button aria-label="Close menu" className="-m-1 p-1" type="button" data-headlessui-state="open" onClick={handleNav}><svg viewBox="0 0 24 24" aria-hidden="true" className="h-6 w-6 text-zinc-500 dark:text-zinc-400"><path d="m17.25 6.75-10.5 10.5M6.75 6.75l10.5 10.5" fill="none" stroke="currentColor" strokeWidth-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg></button>
