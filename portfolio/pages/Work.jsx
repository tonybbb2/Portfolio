                                        ...
                                        <div class="mb-6 lg:mb-0">
                                            <div class="relative block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-zinc-800">
                                                ...
                                                <div class="p-6 text-center">
                                                    ...
                                                    <p class="mb-6 text-zinc-500 dark:text-zinc-400">
                                                        AI Mastery Course is an application that allow users to create their own course on any subject they want.
                                                    </p>
                                                    <div className="flex grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 text-center gap-1 p-2">
                                                        <span class="flex items-center justify-center bg-black text-[10px] me-2 py-0.5 rounded text-white"><SiNextdotjs className="text-xs mr-2" />Next.js</span>
                                                        <span class="flex items-center justify-center bg-[#3b7bc2] text-[10px] me-2 py-0.5 rounded text-white"><BiLogoTypescript className="text-xs mr-2" />Typescript</span>
                                                        <span class="flex items-center justify-center bg-[#090e43] text-[10px] me-2 py-0.5 rounded text-white"><TbSlashes className="text-xs mr-2" />Shadcn</span>
                                                        <span class="flex items-center justify-center bg-[#212733] text-[10px] me-2 py-0.5 rounded text-white"><SiPrisma className="text-xs mr-2" />Prisma</span>
                                                        <span class="flex items-center justify-center bg-black text-[10px] me-2 py-0.5 rounded text-white"><SiOpenai className="text-xs mr-2" />OpenAI</span>
                                                        <span class="flex items-center justify-center bg-zinc-400 text-[10px] me-2 py-0.5 rounded text-white"><FcGoogle className="text-xs mr-2" />Google auth</span>
                                                        <span class="flex items-center justify-center bg-[#635bff] text-[10px] me-2 py-0.5 rounded text-white"><BsStripe className="text-xs mr-2" />Stripe</span>
                                                        <span class="flex items-center justify-center bg-[#ff0000] text-[10px] me-2 py-0.5 rounded text-white"><BsYoutube className="text-xs mr-2" />YT api</span>
                                                    </div>
                                                    <div className="flex justify-center items-center mt-6 gap-2">
                                                        <button
                                                            className="flex items-center gap-2 px-6 py-3 font-sans text-xs font-bold text-center text-gray-900 dark:text-white uppercase align-middle transition-all rounded-full select-none bg-white shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 dark:border dark:border-zinc-700/50 dark:bg-zinc-700 dark:ring-0 dark:ring-white/10 dark:hover:border-zinc-700 dark:hover:ring-white/20"
