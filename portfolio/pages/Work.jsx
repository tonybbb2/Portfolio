              ...
              <div className="mx-auto max-w-2xl lg:max-w-5xl">
                <header className="max-w-full none md:flex">
                  ...
                  <div className="self-center text-center h-full w-full overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-200px),transparent_100%)]">
                    ...
                    <div className="w-full inline-flex flex-nowrap mt-4">
                ...
                <div className="mt-16 sm:mt-20 p-12">
                  <div className="grid md:grid-cols-2 gap-8">
                    <div className="mb-6 lg:mb-0">
                      <div className="relative block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-zinc-800">
                        <div className="flex">
                          <div className="relative mx-4 -mt-4 w-full overflow-hidden rounded-lg bg-cover bg-no-repeat shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]">
                            <Image
                              ...
                              width={500}
                              height={200}
                              alt="VI Fitness application preview"
                              loading="eager"
                              sizes="(min-width: 768px) 500px, calc(100vw - 8rem)"
                            />
                          </div>
                        </div>
                        <div className="p-6 text-center">
                          <h5 className="mb-4 text-xl font-bold text-zinc-800 dark:text-white">
                          ...
                          <div className="flex grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 text-center gap-1 p-2">
                            <span className="flex items-center justify-center bg-blue-900 text-[10px] me-2 py-0.5 rounded text-white">
                              <SiKotlin className="text-xs mr-2" />
                              Kotlin
                            </span>
                            <span className="flex items-center justify-center bg-[#3C983C] text-[10px] me-2 py-0.5 rounded text-white">
                              <BiLogoNodejs className="text-xs mr-2" />
                              Node.js
                            </span>
                            <span className="flex items-center justify-center bg-[#EDD729] text-[10px] me-2 py-0.5 rounded text-white">
                              <BiLogoJavascript className="text-black text-xs mr-2" />
                              JavaScript
                            </span>
                            <span className="flex items-center justify-center bg-black text-[10px] me-2 py-0.5 rounded text-white">
                              <SiOpenai className="text-xs mr-2" />
                              OpenAI
                            </span>
                            <span className="flex items-center justify-center bg-[#4E7EA2] text-[10px] me-2 py-0.5 rounded text-white">
                              <DiMysql className="text-xs mr-2" />
                              MySQL
                            </span>
                            <span className="flex items-center justify-center bg-orange-700 text-[10px] me-2 py-0.5 rounded text-white">
                              <SiFirebase className="text-xs mr-2" />
                              Firebase
                            </span>
                            <span className="flex items-center justify-center bg-[#46AF61] text-[10px] me-2 py-0.5 rounded text-white">
                              <SiGooglemaps className="text-xs mr-2" />
                              GoogleMaps
                            </span>
                            <span className="flex items-center justify-center bg-[#4A0E97] text-[10px] me-2 py-0.5 rounded text-white">
                    ...
                    <div className="mb-6 lg:mb-0">
                      <div className="relative block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-zinc-800">
                        <div className="flex">
                          <div className="relative mx-4 -mt-4 w-full overflow-hidden rounded-xl bg-cover bg-no-repeat shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]">
                            <Image
                              className="rounded-xl hover:scale-150 transition duration-500 cursor-pointer object-cover"
                              src={backgroundImg3}
                              width={500}
                              height={200}
                              alt="AI Mastery Course preview"
                              loading="eager"
                              sizes="(min-width: 768px) 500px, calc(100vw - 8rem)"
                            />
                          </div>
                        ...
                        <div className="p-6 text-center">
                          ...
                          <div className="flex grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 text-center gap-1 p-2">
                            ...
                            <span className="flex items-center justify-center bg-[#3b7bc2] text-[10px] me-2 py-0.5 rounded text-white">
                              <BiLogoTypescript className="text-xs mr-2" />
                              Typescript
                            </span>
                            <span className="flex items-center justify-center bg-[#090e43] text-[10px] me-2 py-0.5 rounded text-white">
                              <TbSlashes className="text-xs mr-2" />
                              Shadcn
                            </span>
                            <span className="flex items-center justify-center bg-[#212733] text-[10px] me-2 py-0.5 rounded text-white">
                            ...
                            <span className="flex items-center justify-center bg-zinc-400 text-[10px] me-2 py-0.5 rounded text-white">
                              <FcGoogle className="text-xs mr-2" />
                              Google auth
                            </span>
                            <span className="flex items-center justify-center bg-[#635bff] text-[10px] me-2 py-0.5 rounded text-white">
                              <BsStripe className="text-xs mr-2" />
                              Stripe
                            </span>
                            <span className="flex items-center justify-center bg-[#ff0000] text-[10px] me-2 py-0.5 rounded text-white">
                    ...
                    <div className="mb-6 lg:mb-0">
                      <div className="relative block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-zinc-800">
                        ...
                        <div className="p-6 text-center">
                          ...
                          <div className="flex grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 text-center gap-1 p-2">
                            <span className="flex items-center justify-center bg-[#67D4F2] text-[10px] me-2 py-0.5 rounded text-white">
                            ...
                            <span className="flex items-center justify-center bg-orange-400 text-[10px] me-2 py-0.5 rounded text-white">
                              <SiAuthelia className="text-xs mr-2" />
                              Firebase auth
                            </span>
                            <span className="flex items-center justify-center bg-[#17B5D0] text-[10px] me-2 py-0.5 rounded text-white">
                              <BiLogoTailwindCss className="text-xs mr-2" />
                              Tailwind CSS
                            </span>
                            <span className="flex items-center justify-center bg-[#0D253F] text-[10px] me-2 py-0.5 rounded text-white">
